...
#create new model if it doesn't exist yet
    ...
    # Define Model
    model = Sequential()
    model.add(Conv2D(16, kernel_size=(9,9), activation='relu', input_shape=(64, 64, 1)))  # 1.convolutional layer
    model.add(MaxPooling2D(pool_size=(4,4)))
    model.add(Conv2D(8, kernel_size=(5,5), activation='relu'))                           # 2. convolutional layer
